...
function DesignPage2() {
  return (
    <div className='page2container'>
        ...
        <h2 style={{color:"orangered"}}>TRAINERS</h2>
        </div>
...
Training Studio Template is 100% free to download </p>
       ...
       <p style={{color:"orangered" ,marginTop:"5px", textAlign:"left"}}> strongth trainer</p>
       ...
       <p className='paragraphStyle'>business website You can adapt this</p>
        ...
        <p style={{color:"orangered" ,marginTop:"3px", textAlign:"left"}}>muscle trainer</p>
       ...
       <p className='paragraphStyle'>business website You can adapt this</p>
        ...
        <p style={{color:"orangered" ,marginTop:"3px", textAlign:"left"}}> power trainer</p>
